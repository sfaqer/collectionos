...
Процедура ИтераторСоздается() Экспорт
	...
	// Когда
	Результат = Новый ИтераторКлючСоответствие(Новый Соответствие, ЭтотОбъект);
...
Процедура ЕстьСледующий() Экспорт
	...
	Итератор = Новый ИтераторКлючСоответствие(Коллекция, ЭтотОбъект);
...
Процедура НетСледующего() Экспорт
	...
	Итератор = Новый ИтераторКлючСоответствие(Новый Соответствие, ЭтотОбъект);
...
Процедура СледующийВызываетИсключениеПриКонкурентнойМодификации() Экспорт
	...
	Итератор = Новый ИтераторКлючСоответствие(Соответствие, ЭтотОбъект);
...
Процедура ПриМутацииИтераторомИнвалидируютсяДругиеИтераторы() Экспорт
	...
	ИтераторМутирующий       = Новый ИтераторКлючСоответствие(Коллекция, ЭтотОбъект);
	ИтераторИнвалидирующийся = Новый ИтераторКлючСоответствие(Коллекция, ЭтотОбъект);
