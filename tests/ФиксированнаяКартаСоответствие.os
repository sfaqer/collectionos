...
&Тест
Процедура ФиксированнаяКартаСоответствиеСоздается() Экспорт

	// Дано

	// Когда

	Результат = Новый ФиксированнаяКартаСоответствие();

	// Тогда

	Ожидаем.Что(Результат).ИмеетТип("ФиксированнаяКартаСоответствие");
...
Процедура СодержитКлюч() Экспорт
	...
	ПроверяемаяКарта = Новый ФиксированнаяКартаСоответствие();
