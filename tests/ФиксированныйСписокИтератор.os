...
Процедура ИтераторСоздается() Экспорт
	...
	Результат = Новый ФиксированныйСписокИтератор(Новый ИтераторМассив(Новый Массив, ЭтотОбъект));
...
Процедура НетСледующего() Экспорт
	...
	Итератор = Новый ФиксированныйСписокИтератор(Новый ИтераторМассив(Новый Массив, ЭтотОбъект));
