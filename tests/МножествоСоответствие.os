...
&Тест
Процедура ОчиститьОповещаетОбИзменении() Экспорт
	...
	МножествоСоответствие.Итератор();

	КоллекцияМодифицирована = Ложь;
	ДобавитьОбработчик МножествоСоответствие.КоллекцияМодифицирована, КоллекцияМодифицирована;
