...
Процедура ДляКаждогоОставшегосяЛямбда() Экспорт
	...
	Итератор.ДляКаждогоОставшегося(
		...
		|	ТестМодуль.СуммаЭлементов = ТестМодуль.СуммаЭлементов + Элемент.Ключ + Элемент.Значение;"
	);
...
Процедура ДляКаждогоОставшегосяЛямбдаКонтекстСтруктура() Экспорт
	...
	Итератор.ДляКаждогоОставшегося(
		...
		|	Контекст.СуммаЭлементов = Контекст.СуммаЭлементов + Элемент.Ключ + Элемент.Значение;",
...
Процедура ДляКаждогоОставшегосяЛямбдаКонтекстОбъект() Экспорт
	...
	Итератор.ДляКаждогоОставшегося(
		...
		|	СуммаЭлементов = СуммаЭлементов + Элемент.Ключ + Элемент.Значение;",
		ТестМодуль
	);
