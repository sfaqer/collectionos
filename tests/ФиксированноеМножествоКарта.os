...
&Тест
Процедура ФиксированноеМножествоКартаСоздается() Экспорт

	// Когда

	Результат = Новый ФиксированноеМножествоКарта;

	// Тогда

	Ожидаем.Что(Результат).ИмеетТип("ФиксированноеМножествоКарта");

КонецПроцедуры

&Тест
Процедура ФиксированноеМножествоКартаСоздаетсяКопированием() Экспорт
	...
	Результат = Новый ФиксированноеМножествоКарта(КопируемоеМножество);
...
Процедура Итератор() Экспорт
	...
	ФиксированноеМножество = Новый ФиксированноеМножествоКарта;
