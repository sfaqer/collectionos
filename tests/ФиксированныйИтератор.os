...
Процедура ИтераторСоздается() Экспорт
	...
	Результат = Новый ФиксированныйИтератор(
		Новый ИтераторСоответствие(Новый Соответствие, ЭтотОбъект)
	);
...
Процедура НетСледующего() Экспорт
	...
	Итератор = Новый ФиксированныйИтератор(Новый ИтераторСоответствие(Новый Соответствие, ЭтотОбъект));
