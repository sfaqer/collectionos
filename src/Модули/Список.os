Функция ИзЭлементов(	
	...
	Возврат Новый ФиксированныйСписокМассив(Результат);
...
Функция Скопировать(Коллекция) Экспорт
	...
	ФиксированныеСписки.Добавить(Тип("ФиксированныйСписокМассив"));

	Если ФиксированныеСписки.Найти(ТипЗнч(Коллекция)) <> Неопределено Тогда
		Возврат Коллекция;
	КонецЕсли;
