...
Процедура ПриЗагрузкеБиблиотеки(Путь, СтандартнаяОбработка, Отказ)
	...
	ОбработатьКаталогКлассов(ОбъединитьПути(Путь, "Классы"), СтандартнаяОбработка, Отказ);
	ОбработатьКаталогМодулей(ОбъединитьПути(Путь, "Модули"), СтандартнаяОбработка, Отказ);
