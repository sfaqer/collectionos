...
Функция ВычислитьБезусловно(Ключ, ФункцияПереназначения) Экспорт
	...
	Попытка
		Результат = ВнутренняяКарта.ВычислитьБезусловно(Ключ, ФункцияПереназначения);
	Исключение
		Блокировка.Разблокировать();
		ВызватьИсключение;
	КонецПопытки;
...
Функция ВычислитьЕслиОтсутствует(Ключ, ФункцияНазначения) Экспорт
	...
	Попытка
		Результат = ВнутренняяКарта.ВычислитьЕслиОтсутствует(Ключ, ФункцияНазначения);
	Исключение
		Блокировка.Разблокировать();
		ВызватьИсключение;
	КонецПопытки;
...
Функция ВычислитьЕслиПрисутствует(Ключ, ФункцияПереназначения) Экспорт
	...
	Попытка
		Результат = ВнутренняяКарта.ВычислитьЕслиПрисутствует(Ключ, ФункцияПереназначения);
	Исключение
		Блокировка.Разблокировать();
		ВызватьИсключение;
	КонецПопытки;
...
Функция Слить(Ключ, Значение, ФункцияПереназначения) Экспорт
	...
	Попытка
		Результат = ВнутренняяКарта.Слить(Ключ, Значение, ФункцияПереназначения);
	Исключение
		Блокировка.Разблокировать();
		ВызватьИсключение;
	КонецПопытки;
...
Процедура ЗаменитьВсе(ФункцияПереназначения) Экспорт
	...
	Попытка
		ВнутренняяКарта.ЗаменитьВсе(ФункцияПереназначения);
	Исключение
		Блокировка.Разблокировать();
		ВызватьИсключение;
	КонецПопытки;
